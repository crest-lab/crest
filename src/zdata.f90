...
!==========================================================================================================!
   ...
   type :: zatom
      ...
      integer,allocatable  :: prio(:)    ! priority of neighbor chains
...
!==========================================================================================================!
   ...
   !--- regular atom
      ...
      real(wp),allocatable :: zmat(:,:)    !internal coordinates of the molecule, requires tracking zna,znb,znc
...
!==========================================================================================================!
   ...
   !--- data
       integer :: nat  = 0
       integer :: nall = 0
       integer,allocatable :: vnat(:)     !used instead of nat if not all structures have the same number of atoms
       ...
       return
        ...
        do i=1,self%zat(atm)%nei
          ...
          do j=1,self%zat(atm)%nei
            ...
            !if(self%ngt(j)==self%ngt(i))c=c+1
          enddo
          if(c==2) itis=.true.
        enddo 
    endif
...
!==========================================================================================================!
! MREC routine for the ZMOLECULE class, i.e., parse the neighbpurlist recursively
